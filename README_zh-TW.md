...
<!-- LIVE_STATS:START -->
> **即時數據** · 更新於 2026-07-31 17:15 ET · *由 RPi cron 自動產生*
>
> | | Trader (Alpaca 模擬) | DOWTrade (MYM 模擬) |
> |---|---|---|
> | 淨值 | $105,327.21 | $1,000,665.56 |
> | 報酬率 | +5.33% | +0.067% |
> | 持倉 | 20/20 | 空倉 |
> | 當日損益 | $+473.55 | — |
> | 總交易次數 | — | 12 |
> | 漲幅前三 | MSFT +18.3%, AMZN +14.0%, BAC +7.3% | |
> | 跌幅前三 | HD -3.8%, NFLX -2.7%, WFC -1.8% | |
...
ESP8266 + CC1101 868 MHz → 嗅探專有 RF 訊號 / 讀取全屋使用瓦數
