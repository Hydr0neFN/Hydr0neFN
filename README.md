...
> |---|---|---|
> | Equity | $105,111.44 | $1,001,479.63 |
> | Return | +5.11% | +5.92% |
> | Net P&L | — | $+1,479.63 |
> | Positions | 20/20 | FLAT |
> | Day P&L | $-844.90 | — |
> | Total Trades | — | 88 |
> | Top | AMD +10.4%, META +8.4%, TMO +7.2% | |
> | Bottom | NOW -3.3%, KO -1.8%, MSFT -1.8% | |
>
...
> Control arm: identical 15m bars, identical 2xATR stop and sizing, with the LLM ensemble replaced by a plain EMA(9/21) cross -> **$-4,250.47 over 225 trades** (24.0% win rate, -0.044R avg). Re-pricing the LLM version under the **same cost model** (one tick of adverse slippage per fill plus commission) gives **$+1,082.63 over 88 round trips**. The Net P&L row above is as-booked and predates that cost model, which applies to positions opened from 2026-09-09.
