...
<!-- LIVE_STATS:START -->
> **Live Stats** · updated 2026-09-10 17:15 ET · *auto-generated by RPi cron*
>
> | | Trader (Alpaca Paper) | DOWTrade (MYM Sim) |
> |---|---|---|
> | Equity | $105,762.89 | $1,001,617.41 |
> | Return | +5.76% | +6.47% |
> | Net P&L | — | $+1,617.41 |
> | Positions | 20/20 | SHORT 3 |
> | Day P&L | $-174.61 | — |
> | Total Trades | — | 86 |
> | Top | CVX +6.9%, ORCL +4.3%, META +4.5% | |
> | Bottom | MRK -4.0%, MSFT -2.9%, CSCO -1.9% | |
>
...
> Control arm: identical 15m bars, identical 2xATR stop and sizing, with the LLM ensemble replaced by a plain EMA(9/21) cross -> **$-4,036.78 over 224 trades** (24.1% win rate, -0.040R avg). Re-pricing the LLM version under the **same cost model** (one tick of adverse slippage per fill plus commission) gives **$+1,344.03 over 86 round trips**. The Net P&L row above is as-booked and predates that cost model, which applies to positions opened from 2026-09-09.
