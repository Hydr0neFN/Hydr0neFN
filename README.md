...
<!-- LIVE_STATS:START -->
> **Live Stats** · updated 2026-09-24 17:15 ET · *auto-generated by RPi cron*
>
> | | Trader (Alpaca Paper) | DOWTrade (MYM Sim) |
> |---|---|---|
> | Equity | $106,499.26 | $1,001,806.92 |
> | Return | +6.50% | +7.23% |
> | Net P&L | — | $+1,806.92 |
> | Positions | 24/24 | SHORT 3 |
> | Day P&L | $+145.10 | — |
> | Total Trades | — | 90 |
> | Top | AMD +24.6%, META +26.0%, TMO +11.6% | |
> | Bottom | CVX -2.3%, NOW -2.1%, KO -1.8% | |
>
...
> Control arm: identical 15m bars, identical 2xATR stop and sizing, with the LLM ensemble replaced by a plain EMA(9/21) cross -> **$-4,968.49 over 235 trades** (23.8% win rate, -0.059R avg). Re-pricing the LLM version under the **same cost model** (one tick of adverse slippage per fill plus commission) gives **$+649.44 over 90 round trips**. The Net P&L row above is as-booked and predates that cost model, which applies to positions opened from 2026-09-09.
