...
<!-- LIVE_STATS:START -->
> **Live Stats** · updated 2026-09-22 17:15 ET · *auto-generated by RPi cron*
>
> | | Trader (Alpaca Paper) | DOWTrade (MYM Sim) |
> |---|---|---|
> | Equity | $106,650.53 | $1,001,046.90 |
> | Return | +6.65% | +4.19% |
> | Net P&L | — | $+1,046.90 |
> | Positions | 24/24 | SHORT 2 |
> | Day P&L | $+238.54 | — |
> | Total Trades | — | 90 |
> | Top | AMD +23.0%, META +19.6%, TMO +8.3% | |
> | Bottom | CVX -3.6%, CRM -2.9%, NOW -2.6% | |
>
...
> Control arm: identical 15m bars, identical 2xATR stop and sizing, with the LLM ensemble replaced by a plain EMA(9/21) cross -> **$-4,745.45 over 234 trades** (23.9% win rate, -0.054R avg). Re-pricing the LLM version under the **same cost model** (one tick of adverse slippage per fill plus commission) gives **$+649.94 over 90 round trips**. The Net P&L row above is as-booked and predates that cost model, which applies to positions opened from 2026-09-09.
