...
<!-- LIVE_STATS:START -->
> **Live Stats** · updated 2026-09-25 17:15 ET · *auto-generated by RPi cron*
>
> | | Trader (Alpaca Paper) | DOWTrade (MYM Sim) |
> |---|---|---|
> | Equity | $106,804.38 | $1,001,127.21 |
> | Return | +6.80% | +4.51% |
> | Net P&L | — | $+1,127.21 |
> | Positions | 24/24 | FLAT |
> | Day P&L | $+265.20 | — |
> | Total Trades | — | 92 |
> | Top | AMD +24.7%, TMO +11.0%, AAPL +6.8% | |
> | Bottom | NOW -3.4%, CVX -3.0%, CRM -2.4% | |
>
...
> Control arm: identical 15m bars, identical 2xATR stop and sizing, with the LLM ensemble replaced by a plain EMA(9/21) cross -> **$-4,871.12 over 237 trades** (24.1% win rate, -0.057R avg). Re-pricing the LLM version under the **same cost model** (one tick of adverse slippage per fill plus commission) gives **$+721.21 over 92 round trips**. The Net P&L row above is as-booked and predates that cost model, which applies to positions opened from 2026-09-09.
