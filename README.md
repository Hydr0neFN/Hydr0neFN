...
Me use AI as ability amp/ thinking assist, learning tech news and AI day to day basis.

### Thinking Loop
Me think -> Claude Opus 4.6 debates/ think with me @claude.ai (holds personal memory) -> (@claude code) Fable refine plan (optional, costly) ->(@claude code) Claude Sonnet 5 execute with Opus 4.8 as advisor and produce HANDOFF.md for decision and result -> Claude Opus 4.6 review with me; sends Gemini(agy)/Grok/Chatgpt(codex)/ Copilot for reviewing: consult-bridge -> Next iteration.

<!-- LIVE_STATS:START -->
> **Live Stats** · updated 2026-07-22 00:07 ET · *auto-generated by RPi cron*
>
> | | Trader (Alpaca Paper) | DOWTrade (MYM Sim) |
> |---|---|---|
> | Equity | $104,811.81 | $1,000,665.56 |
> | Return | +4.81% | +0.067% |
> | Positions | 20/20 | FLAT |
> | Day P&L | $+477.07 | — |
> | Total Trades | — | 12 |
> | Top | MA +8.1%, BAC +6.1%, PM +5.9% | |
> | Bottom | HD -4.2%, AVGO -0.8%, LIN -2.6% | |
